...
char JogoDaVelha::operator()(int I, int J) const
{
    // Checa os indices
...
bool JogoDaVelha::jogadaValida(int I, int J) const
{
    // Alguem jah ganhou o jogo?
...
void JogoDaVelha::fazerJogada(int I, int J)
{
    if (jogadaValida(I,J))
    {
        x[I][J] = vez;
